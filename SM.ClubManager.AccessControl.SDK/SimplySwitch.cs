...
namespace SM.ClubManager.AccessControl.SDK
{
    public class SimplySwitch : ISimplySwitch
    {
        ...
        public SResponse Restart()
        {
            throw new NotImplementedException();
        }

        public SResponse SClose(string ComPort, int BaudRate)
        {
            throw new NotImplementedException();
        }

        public SResponse SClose()
        {
            throw new NotImplementedException();
        }

        public SResponse SOpen(string ComPort, int BaudRate)
        {
            throw new NotImplementedException();
        }

        public SResponse SOpen()
        {
            throw new NotImplementedException();
        }
